...
<script type="text/javascript">
    ...
    /*  遍历渲染  */
    let xx=(text,i)=>{
        let str=`<li><span><i class="fa fa-trash-o fa-lg"></i><a href="${text.downloadurl}">${text.filename}</a></span><span>${text.count}</span><span>xxx</span><span>${text.upfile_time}</span><span class="label">${text.filelabel}</span></li>`;
